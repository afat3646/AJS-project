...
{
    public partial class SrvEducacion : Form
    {
        public SrvEducacion()
        {
            InitializeComponent();
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            Categoria_Txt.Text = "COLEGIATURA";
        }
        ...
        private void Pagar_Btn_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection conexion = new MySqlConnection(conexionString))
            {
                ...
                {
                    conexion.Open();
                    string pago_srveducativos = "UPDATE Usuario SET Balance = Balance - @MontoSrvEducativos WHERE No_Usuario = 1";
                    ...
                    using (MySqlCommand restar_monto = new MySqlCommand(pago_srveducativos, conexion))
                    {
                        ...
                        else
                        {
                            using (MySqlCommand insertar_registro_pagosrv = new MySqlCommand(insert_registro, conexion))
                            {
                                ...
                                insertar_registro_pagosrv.Parameters.AddWithValue("@CategoriaTxt", "EDUCATIVOS");
                            ...
                            restar_monto.Parameters.AddWithValue("@MontoSrvEducativos", Convert.ToDouble(Monto_TxtBox.Text)); // El nuevo valor viene del TextBox Monto_TxtBox.
        ...
        private void SrvEducacion_Load(object sender, EventArgs e)
        {
