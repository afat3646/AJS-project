...
namespace Transacciones_Finanzas
{
    public partial class Streaming : Form
    {
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            Categoria_Txt.Text = "NETFLIX";
        }

        private void pictureBox9_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "DISNEY +";
        }

        private void pictureBox5_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "STAR +";
        }

        private void pictureBox6_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "PRIME VIDEO";
        }

        private void pictureBox8_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "HBO MAX";
        }

        private void pictureBox4_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "PARAMOUNT +";
        }

        private void pictureBox7_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "APPLE TV";
        }

        private void pictureBox3_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "APPLE MUSIC";
        }

        private void pictureBox10_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "SPOTIFY";
        }

        private void pictureBox11_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "CRUNCHYROLL";
        }
        ...
        private void Pagar_Btn_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection conexion = new MySqlConnection(conexionString))
            {
                ...
                {
                    conexion.Open();
                    string pago_srvstreaming = "UPDATE Usuario SET Balance = Balance - @MontoSrvStreaming WHERE No_Usuario = 1";
                    ...
                    using (MySqlCommand restar_monto = new MySqlCommand(pago_srvstreaming, conexion))
                    {
                        ...
                        else
                        {
                            using (MySqlCommand insertar_registro_pagosrv = new MySqlCommand(insert_registro, conexion))
                            {
                                ...
                                insertar_registro_pagosrv.Parameters.AddWithValue("@CategoriaTxt", "STREAMING");
                            ...
                            restar_monto.Parameters.AddWithValue("@MontoSrvStreaming", Convert.ToDouble(Monto_TxtBox.Text)); // El nuevo valor viene del TextBox Monto_TxtBox.
