...
namespace Transacciones_Finanzas
{
    public partial class Telefonia : Form
    {
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            Categoria_Txt.Text = "TELCEL";
        }

        private void pictureBox9_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "ATNT";
        }

        private void pictureBox5_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "MOVISTAR";
        }

        private void pictureBox6_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "UNEFON";
        }

        private void pictureBox8_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "VIRGIN";
        }

        private void pictureBox4_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "PILLO FON";
        }

        private void pictureBox7_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "BAIT";
        }
        ...
        private void Pagar_Btn_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection conexion = new MySqlConnection(conexionString))
            {
                ...
                {
                    conexion.Open();
                    string pago_srvtelefonia = "UPDATE Usuario SET Balance = Balance - @MontoSrvTelefonia WHERE No_Usuario = 1";
                    ...
                    using (MySqlCommand restar_monto = new MySqlCommand(pago_srvtelefonia, conexion))
                    {
                        ...
                        else
                        {
                            using (MySqlCommand insertar_registro_pagosrv = new MySqlCommand(insert_registro, conexion))
                            {
                                ...
                                insertar_registro_pagosrv.Parameters.AddWithValue("@CategoriaTxt", "TELEFONÍA");
                            ...
                            restar_monto.Parameters.AddWithValue("@MontoSrvTelefonia", Convert.ToDouble(Monto_TxtBox.Text)); // El nuevo valor viene del TextBox Monto_TxtBox.
        ...
        private void Telefonia_Load(object sender, EventArgs e)
        {
