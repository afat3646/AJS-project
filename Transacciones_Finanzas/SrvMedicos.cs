...
{
    public partial class SrvMedicos : Form
    {
        public SrvMedicos()
        {
            InitializeComponent();
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            Categoria_Txt.Text = "INSUMOS";
        }

        private void pictureBox9_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "INTERVENCIONES";
        }

        private void pictureBox5_Click(object sender, EventArgs e)
        {
            Categoria_Txt.Visible = true;
            Categoria_Txt.Text = "CONSULTAS";
        }
        ...
        private void Pagar_Btn_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection conexion = new MySqlConnection(conexionString))
            {
                ...
                {
                    conexion.Open();
                    string pago_srvmedicos = "UPDATE Usuario SET Balance = Balance - @MontoSrvMedico WHERE No_Usuario = 1";
                    ...
                    using (MySqlCommand restar_monto = new MySqlCommand(pago_srvmedicos, conexion))
                    {
                        ...
                        else
                        {
                            using (MySqlCommand insertar_registro_pagosrv = new MySqlCommand(insert_registro, conexion))
                            {
                                ...
                                insertar_registro_pagosrv.Parameters.AddWithValue("@CategoriaTxt", "MÉDICOS");
                            ...
                            restar_monto.Parameters.AddWithValue("@MontoSrvMedico", Convert.ToDouble(Monto_TxtBox.Text)); // El nuevo valor viene del TextBox Monto_TxtBox.
        ...
        private void SrvMedicos_Load(object sender, EventArgs e)
        {
